...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post autors_url, params: { autor: { apellido: @autor.apellido, nombre: @autor.nombre } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { apellido: @autor.apellido, nombre: @autor.nombre } }
